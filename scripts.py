...
<b>Powered By : <a href='https://t.me/ML_BotUpdates'>• мℓ вσт υρ∂αтєѕ •</a></b>\n"""
    ...
    TRYING_TO_UPLOAD = "<b>Trying to upload.... Pᴏᴡᴇʀᴅᴇᴅ Bʏ : @ML_BotUpdates</b>"
    RENAMED_SUCCESS = "<b>Renamed Successfully... Pᴏᴡᴇʀᴅᴇᴅ Bʏ : @ML_BotUpdates</b>"
    ...
    NO_THUMBNAIL_FOUND = "<b>sed No Thumbnail Found 😟</b>"
    TRYING_TO_DOWNLOAD = "<b>Trying To Download....Pᴏᴡᴇʀᴅᴇᴅ Bʏ : @ML_BotUpdates</b>"
    UPLOAD_SUCCESS = "<u><b>Thanks for using meh..! Share & Support @ML_BotUpdates🥰</b></u>"
    REPLY_TO_VIDEO = "<b>Reply to that file with /convert</b>"
    UPLOAD_START = "<b>Uploading your file please wait...Pᴏᴡᴇʀᴅᴇᴅ Bʏ : @ML_BotUpdates</b>\n"
    ...
    CONTACT_MY_DEVELOPER = "<b>Something Wrong Contact My Developer @Itz_Me_Malayaali 🤯</b>"
    REPLY_TO_MEDIA = "<b>Reply to that Media with /rename_video New Name</b>"
    START_TEXT = "<b>Hey..<b>{}</b>\n  I Aᴍ A Sɪᴍᴘʟᴇ Rᴇɴᴀᴍᴇ Bᴏᴛ I Cᴀɴ Rᴇɴᴀᴍᴇ Fɪʟᴇs Wɪᴛʜ Cᴜᴛsᴏᴍ Tʜᴜᴍʙɴᴀɪʟ Aɴᴅ Uᴘʟᴏᴀᴅ As Vɪᴅᴇᴏ Oʀ Fɪʟᴇ.   💯 If You Found Any Bugs Please Contact Our Group : @ML_SupportGroup</b>"
